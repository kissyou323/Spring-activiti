...
<script type="text/javascript">
  ...
  $(document).ready(function(){
	    ...
	    url:"getprocesslists",
	        ...
	        {
	            return "<a target=\"_blank\" href=\"showresource?pdid="+row.id+"&resource="+encodeURIComponent(encodeURIComponent(row.resourceName))+"\">"  + row.resourceName + "</a>";
	        },
	        "picname":function(column, row)
	        {
	        	return "<a target=\"_blank\" href=\"showresource?pdid="+row.id+"&resource="+encodeURIComponent(encodeURIComponent(row.diagramresourcename))+"\">"  + row.diagramresourcename + "</a>";
	        },
	    	}
